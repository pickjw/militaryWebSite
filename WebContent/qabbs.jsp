...
<body>
	...
	<div class="container">
		<div class="row">   <!-- 홀수짝수 색깔변경 -->
			<table class="table table-striped"
				style="text-align: center; border: 2px solid #dddddd"><!-- 회색빛 -->
				<thead>                                       <!-- 회색빛 -->
					<tr>
						<th style="background-color: #eeeeee; text-align: center;">No</th>
						<th style="background-color: #eeeeee; text-align: center;">Title</th>
						<th style="background-color: #eeeeee; text-align: center;">Nickname</th>
						<th style="background-color: #eeeeee; text-align: center;">Date Created</th>
					</tr>                           <!-- 회색빛 -->
				</thead>
				<tbody>
					<%
					...
					<tr>
						...
						<td><%=list.get(i).getBbsDate().substring(0, 11) + list.get(i).getBbsDate().substring(11, 13) + "Hr"+"&nbsp;"
						+ list.get(i).getBbsDate().substring(14, 16) + "Min" %></td>
					</tr>
					<%
						}
					%>
			...
			%>	
			<a href="write.jsp" class="btn btn-danger pull-right">Writing</a>
		</div>
	</div>
